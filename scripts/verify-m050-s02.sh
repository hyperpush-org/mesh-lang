...
CURRENT_REPO_BLOB_BASE = 'https://github.com/hyperpush-org/mesh-lang/blob/main/'
    ...
    'getting_started': {
        ...
        'markers': marker_map(
            ...
            [
                ...
                'When you need the staged deploy + failover proof chain',
                'Clustered Example',
                'Production Backend Proof -- the maintainer-facing backend proof page that hands off into the Hyperpush product repo after the starter/examples-first ladder',
            ],
            'getting-started',
        ),
    },
