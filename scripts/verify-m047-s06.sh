...
assert_file_contains_regex \
  contract-readme-product-repo \
  README.md \
  'https://github\.com/hyperpush-org/hyperpush-mono' \
  'README lost the repo-boundary product handoff'
assert_file_omits_regex \
...
assert_file_contains_regex \
  contract-distributed-proof-product-runbook \
  website/docs/docs/distributed-proof/index.md \
  'https://github\.com/hyperpush-org/hyperpush-mono/blob/main/mesher/README\.md' \
  'Distributed Proof lost the product-runbook handoff'
assert_file_contains_regex \
  contract-distributed-proof-product-verifier \
  website/docs/docs/distributed-proof/index.md \
  'bash mesher/scripts/verify-maintainer-surface\.sh' \
  'Distributed Proof lost the product-owned verifier handoff'
assert_file_contains_regex \
...
assert_file_contains_regex \
  contract-distributed-proof-product-repo \
  website/docs/docs/distributed-proof/index.md \
  'https://github\.com/hyperpush-org/hyperpush-mono' \
  'Distributed Proof lost the repo-boundary product handoff'
...
for surface in \
  ...
  assert_file_contains_regex \
    "${safe_name}-product-repo" \
    "$surface" \
    'https://github\.com/hyperpush-org/hyperpush-mono' \
    "$surface lost the repo-boundary product handoff"
  assert_file_contains_regex \
  ...
  assert_file_omits_regex \
    "${safe_name}-stale-local-runbook" \
    "$surface" \
    'https://github\.com/snowdamiz/mesh-lang/blob/main/mesher/README\.md' \
    "$surface still points at the stale mesh-lang-local product runbook"
done
...
assert_file_contains_regex \
  contract-distributed-product-runbook \
  website/docs/docs/distributed/index.md \
  'https://github\.com/hyperpush-org/hyperpush-mono/blob/main/mesher/README\.md' \
  'Distributed Actors lost the product-runbook handoff'
assert_file_contains_regex \
...
assert_file_contains_regex \
  contract-clustered-example-product-repo \
  website/docs/docs/getting-started/clustered-example/index.md \
  'https://github\.com/hyperpush-org/hyperpush-mono' \
  'Clustered Example lost the repo-boundary product handoff'
assert_file_contains_regex \
...
assert_file_omits_regex \
  contract-clustered-example-stale-local-runbook \
  website/docs/docs/getting-started/clustered-example/index.md \
  'https://github\.com/snowdamiz/mesh-lang/blob/main/mesher/README\.md' \
  'Clustered Example still points at the stale mesh-lang-local product runbook'
assert_file_contains_regex \
