...
- Name: mesher/landing/tests/pitch-route.spec.ts >> /pitch navigation >> navigation keyboard input stays bounded and updates inspectable state
- Location: mesher/landing/tests/pitch-route.spec.ts:40:7
