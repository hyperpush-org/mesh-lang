...
- Name: mesher/landing/tests/pitch-route.spec.ts >> /pitch navigation >> navigation indicators jump exactly to the requested slide
- Location: mesher/landing/tests/pitch-route.spec.ts:101:7
