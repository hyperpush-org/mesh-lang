...
- Name: mesher/landing/tests/pitch-route.spec.ts >> /pitch navigation >> navigation deep links honor known hashes and repair stale hashes
- Location: mesher/landing/tests/pitch-route.spec.ts:86:7
...
Call log:
  - navigating to "/pitch#mesh-moat", waiting until "load"
