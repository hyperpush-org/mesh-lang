...
- Name: mesher/landing/tests/pitch-route.spec.ts >> /pitch export >> print media hides interactive chrome and keeps every slide readable in order
- Location: mesher/landing/tests/pitch-route.spec.ts:184:7
...
Call log:
  - navigating to "/pitch#distribution", waiting until "load"
