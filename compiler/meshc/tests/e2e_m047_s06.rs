...
const STALE_REPO_BLOB_BASE: &str = "https://github.com/snowdamiz/mesh-lang/blob/main/mesher/README.md";
...
fn m047_s06_public_docs_split_sqlite_local_from_postgres_clustered_starters() {
    ...
    assert_contains_all(
        "website/docs/docs/distributed/index.md",
        &sources.distributed,
        &["Hyperpush product repo", MESHER_RUNBOOK, MESHER_RUNBOOK_URL],
    );
...
fn m047_s06_docs_layer_s04_s05_s06_and_s07_truthfully() {
    ...
    assert_contains_all(
        "website/docs/docs/distributed/index.md",
        &sources.distributed,
        &["Hyperpush product repo", MESHER_RUNBOOK_URL],
    );
