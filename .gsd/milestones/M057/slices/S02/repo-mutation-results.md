...
- Verified at: `2026-04-10T16:57:37Z`
...
| --- | --- | --- | --- |
| `hyperpush#8` | [`mesh-lang#19`](https://github.com/hyperpush-org/mesh-lang/issues/19) | `OPEN` | Preserve docs-bug history under the language repo. |
...
- Closed shipped `mesh-lang` rows: `10` verified closed with their closeout comments intact.
