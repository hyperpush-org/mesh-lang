...
- [ ] **T02: Build the code-evidence index and naming/ownership map** `est:2h`
...
- [ ] **T03: Assemble the reconciliation ledger and publish the fail-closed audit proof** `est:2h`
