...
| S02 | Core maintainer loop live | high | S01 | ⬜ | The dashboard summaries and issue actions are live: operators can inspect real issues, perform existing issue actions, and see backend-backed summary data instead of broad mock stats. |
